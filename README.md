...
```javascript
alias2pkg = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-alias2pkg@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/namespace-alias2pkg/tags). For example,

```javascript
alias2pkg = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-alias2pkg@v0.4.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var alias2pkg = require( 'path/to/vendor/umd/namespace-alias2pkg/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/namespace-alias2pkg.svg
[npm-url]: https://npmjs.org/package/@stdlib/namespace-alias2pkg

[test-image]: https://github.com/stdlib-js/namespace-alias2pkg/actions/workflows/test.yml/badge.svg?branch=v0.4.1
[test-url]: https://github.com/stdlib-js/namespace-alias2pkg/actions/workflows/test.yml?query=branch:v0.4.1
...
[deno-readme]: https://github.com/stdlib-js/namespace-alias2pkg/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/namespace-alias2pkg/tree/umd
[umd-readme]: https://github.com/stdlib-js/namespace-alias2pkg/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/namespace-alias2pkg/tree/esm
[esm-readme]: https://github.com/stdlib-js/namespace-alias2pkg/blob/esm/README.md
