...
```javascript
alias2pkg = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-alias2pkg@v0.6.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/namespace-alias2pkg/actions/workflows/test.yml/badge.svg?branch=v0.6.0
[test-url]: https://github.com/stdlib-js/namespace-alias2pkg/actions/workflows/test.yml?query=branch:v0.6.0
